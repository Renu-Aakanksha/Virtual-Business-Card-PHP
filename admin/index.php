...
if (isset($_POST['wall'])){
    ...
    $que = "Update `admin` Set `price` = '$price' Where `id`= 1";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 w-100 pr-0 pl-3">
                        ...
                        <div class="small-box bg-gradient-success">
                            <div class="inner">
                                <?php 
                                     $qe = "SELECT id FROM `owners` Where owners.status = 1";
                                     $data = $con->query($qe);
                                     $rows = $data->num_rows;
                                ?>
                    ...
                    <div class="col-lg-3 w-100 pr-0 pl-3">
                        ...
                        <div class="small-box bg-gradient-warning">
                            <div class="inner">
                                <?php 
                                     $qe = "SELECT id FROM `owners` Where owners.status = 0 ";
                                     $data = $con->query($qe);
                                     $rows = $data->num_rows;
                    ...
                    <div class="col-lg-3 w-100 pr-0">
                        ...
                        <div class="small-box bg-gradient-warning">
                            <div class="inner">
                                ...
                                ?>
                                <h5>Partner Card Price</h5>
                                <p>Rs. <?php echo $rows['price']; ?></p>
                            </div>
                            <div class="icon" style="margin: 20px; color:#f1f2f3;">
                                <i class="ion ion-android-desktop"></i>
                            </div>
                            <a href="javascript:;" id="inactive_btn" class="small-box-footer" style="color:white;" data-toggle="modal" data-target="#wall">Set Price <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        <?php
                                        $daydatee = date("d/m/Y");
                                        $qe = "SELECT * FROM `owners` ORDER BY `id` DESC LIMIT 10";
                                        $data = $con->query($qe);
                                        if($data->num_rows > 0){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="msg-title">Set Reseller Card Price</h5>
