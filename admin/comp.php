                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $qe = "SELECT MIN(req_no) AS min_req FROM `credits` where `status` = 2";
                                        $data = $con->query($qe);
                                        $rowww = $data->num_rows;
                                        if($rowww > 0){
                                        ...
                                        $qe = "SELECT MAX(req_no) AS max_req FROM `credits` where `status` = 2";
                                        $data = $con->query($qe);
                                        $rowww = $data->num_rows;
                                        if($rowww > 0){
                                            $rows = $data->fetch_assoc();
                                        ...
                                        if ($reqmin) {
                                            ...
                                            while ($reqmin <= $reqmax){
                                                ...
                                                $qe = "SELECT * from `credits` where req_no = '$reqmin' AND `status` = 2";
                                                $data = $con->query($qe);
                                                if($data->num_rows > 0){
                                                    $srno = $srno + 1;
