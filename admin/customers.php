...
<body>
    ...
    $wurl = $_SESSION['wurl']; 
                                                ...
                                                <tr>
                                                    <th>'.$srno.'</th>
                                                    <th>'.$id.'</th>
                                                    <th><a target="_blank" href="https://'.$wurl.'/'.$url.'">'.$url.'</a></th>
                                                    <th>'.$name.'</th>
                                                    <th>'.$cname.'</th>
                                                    <th>'.$address.'</th>
                                                    <th>'.$mobile.'</th>
                                                    ...
                                                    else if(date('Y-m-d', strtotime( (str_replace('/', '-', $rdatee) ) )) < date('Y-m-d')){
                                                        echo '<span style="color: red;">De-Active</span>';
                                                    }
                                                    else if($status == 1){
