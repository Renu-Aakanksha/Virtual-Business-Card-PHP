...
<!-- Favicons
================================================== -->
<link rel="shortcut icon" href="https://pocketsite.in/dash/assets-card/img/favicon.ico" type="image/x-icon">
<link rel="icon" href="https://pocketsite.in/dash/assets-card/img/favicon.ico" type="image/x-icon">
<!-- / Favicons
================================================== -->

<!-- >> CSS
============================================================================== -->
<link href="https://pocketsite.in/dash/assets-card/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
<!-- Google Web Fonts -->
<link href='https://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<!-- Font Awesome -->
<link href="https://pocketsite.in/dash/assets-card/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet">
<!-- Nivo Lightbox -->
<link href="https://pocketsite.in/dash/assets-card/vendor/nivo-lightbox/nivo-lightbox.css" rel="stylesheet">
<link rel="stylesheet" href="https://pocketsite.in/dash/assets-card/vendor/nivo-lightbox/themes/default/default.css" type="text/css" />
  <!-- /Nivo Lightbox -->
  <!-- Perfect ScrollBar -->
<link href="https://pocketsite.in/dash/assets-card/vendor/perfect-scrollbar/css/perfect-scrollbar.min.css" rel="stylesheet">
<!-- owl carousel -->
<link href="https://pocketsite.in/dash/assets-card/vendor/owl.carousel/owl-carousel/owl.carousel.css" rel="stylesheet">
<link href="https://pocketsite.in/dash/assets-card/vendor/owl.carousel/owl-carousel/owl.theme.css" rel="stylesheet">
<!-- Main Styles -->

<!--<link href="https://pocketsite.in/dash/assets-card/css/styles.css" rel="stylesheet">-->
	...
	<div class="container">
		...
		<div class="section-vcardbody section-home" id="section-home">
			...
			<div class="vcard-profile-pic">
			    <img src="https://pocketsite.in/dash/images/<?php print $bimagef;?>" id="profile2"  alt="Profile Picture"/>
				<img src="https://pocketsite.in/dash/images/<?php print $bimage;?>" id="profile1" class="profileActive" alt="Profile Picture"/>
			</div>
			<!-- /Profile pic -->
			<!-- Description -->
			...
			<div class="vcard-footer">
				...
				<div class="footer-social-icons">
					...
					<a href="https://wa.me/<?php print $wmobile;?>?text=*I'm%20interested%20in%20your%20service*" target="_blank"><i class="fa fa-whatsapp"></i></a>
			...
			<!-- Description feature -->
				...
				<div class="vcard-profile-description-feature">
					...
					<form target="_blank" method="GET" action="https://pocketsite.in/web-control.php">
                        ...
                        <button type="submit" name="whatsappmess" style="width: 30%; border: 1px solid #03449D; display: inline-block; height: 35px; float: right; background-color: <?php echo $themec; ?>; color: white;">Whatsapp</button>
                    </form>
					<!-- item -->
				</div>	
				<!-- /Description feature -->
		...
		<div class="section-vcardbody2 section-page" id="page-about">
            <div>
	            ...
	            <?php
                    if (!empty($sound)){
                        $sound = str_replace('sounds/', '', $sound);
                        echo '<center><audio style="margin-top:10px; width:90%; border-radius: 0px;" controls src="https://pocketsite.in/dash/sounds/'.$sound.'" type="audio/mpeg"></audio></center>
            ...
            while($rows = $data->fetch_assoc()){
                ...
                //if((empty($purl))){
                    ...
                    <div >
                        ...
                        <img src="https://pocketsite.in/dash/images/'.$pimage.'" alt="Product Image">
                        </div>
                        ...
                        if($psellprice > 0){
                            ...
                            <a class="btn btn-default btn-default2" href="https://wa.me/'.$wmobile.'?text=I%20want%20to%20know%20more%20about%20'.$pproduct.'" target="blank" >
                            <i class="fa fa-paper-plane"></i>&nbsp; SEND ENQUIRY</a>';
                            
                        }else{
                            echo'
                            <a class="btn btn-default btn-default2" style="width:100%" href="https://wa.me/'.$wmobile.'?text=I%20want%20to%20know%20more%20about%20'.$pproduct.'" target="blank" >
                            <i class="fa fa-paper-plane"></i>&nbsp;  SEND ENQUIRY</a>';
                    	...
                    	if ($data->num_rows > 0) {
                    		while ($rows = $data->fetch_assoc()) {
                    			...
                    			<div class="project-item">
                    				...
                    				<a href="https://pocketsite.in/dash/images/<?php print $bimage;?>" class="project-thumbnail nivobox" data-lightbox-gallery="portfolio" style="background-image: url('https://pocketsite.in/dash/images/<?php print $bimage;?>');">
			...
			<div class="section-contact">
               ...
               <!-- Contact infos --> 
                ...
                <div class="contact-infos">
                    ...
                    <a target="_blank" href="https://<?php echo $wurl;?>/VcardExport.php?name=<?php print $cnamem;?>&num=<?php print $mobile;?>&email=<?php print $email;?>" class="btn" style="background-color: #269e2a;">Click to Save</a>
...
<!--<script src="https://pocketsite.in/dash/assets-card/vendor/jquery.min.js"></script>-->

<script src="https://pocketsite.in/dash/assets-card/vendor/bootstrap/js/bootstrap.min.js"></script>

<script src="https://pocketsite.in/dash/assets-card/vendor/validate.js"></script>

<script src="https://pocketsite.in/dash/assets-card/vendor/holder.js"></script>

<script src="https://pocketsite.in/dash/assets-card/vendor/nivo-lightbox/nivo-lightbox.min.js"></script>

<script src="https://pocketsite.in/dash/assets-card/vendor/perfect-scrollbar/js/min/perfect-scrollbar.jquery.min.js"></script>

<!--<script src="https://pocketsite.in/dash/assets-card/vendor/owl.carousel/owl-carousel/owl.carousel.js"></script>-->

<script src="http://maps.google.com/maps/api/js?sensor=false"></script>

<script src="https://pocketsite.in/dash/assets-card/vendor/cross-browser.js"></script>


<!--<script src="https://pocketsite.in/assets/js/audio.min.js"></script>-->
...
<script src="https://pocketsite.in/dash/assets-card/js/main.js"></script>
