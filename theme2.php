...
body {
  ...
  <?php if ($custombg == '0'){ ?>
        background: url('https://pocketsite.in/dash/assets-card/img/bg/bg<?php echo $cbg; ?>.png') repeat center center fixed;
  <?php }else { ?>
        background: url('https://pocketsite.in/dash/images/<?php echo $bgimage; ?>') repeat center center fixed;
  <?php } ?>
}
/* ==========================================================
! 03. Buttons
...
<?php  if ($customtx ==  '0'){ ?>
    .section-vcardbody {
    background: url('https://pocketsite.in/dash/assets-card/img/vcard/bg-home<?php echo $texture; ?>.png') repeat-x right top #f4f4f4;
    }
    .section-vcardbody2 {
    background: url('https://pocketsite.in/dash/assets-card/img/vcard/bg-inner<?php echo $texture; ?>.png') repeat-x right top #f4f4f4;
    }

<?php }else{?>
    .section-vcardbody {
    background: url('https://pocketsite.in/dash/images/<?php echo $tximage; ?>') repeat-x right top #f4f4f4;
    }
    .section-vcardbody2 {
    background: url('https://pocketsite.in/dash/assets-card/img/vcard/bg-inner5.png') repeat-y right top #f4f4f4;
    }
<?php }?>
...
.hr1 {
  ...
  height: 1px;
  width: 100%;
  background: url('https://pocketsite.in/dash/assets-card/img/hr1.png') no-repeat center center;
  margin-top: 10px;
  margin-bottom: 10px;
}
.vcard-profile-description-ft-item {
  ...
  padding: 10px;
  background: url('https://pocketsite.in/dash/assets-card/img/bg-btn.png') no-repeat center center <?php echo $hoverc; ?>;
}
...
.testimonial-content {
  background: url('https://pocketsite.in/dash/assets-card/img/bgmask2.png') no-repeat center center <?php echo $hoverc; ?>;
  color: #ffffff;
  padding: 20px;
  border-radius: 10px;
...
.project-item a {
  cursor: url('https://pocketsite.in/dash/assets-card/img/projects2.cur'), projetos !important;
  border-radius: 6px;
...
.blog-item-thumb a {
  cursor: url('https://pocketsite.in/dash/assets-card/img/projects.cur'), projetos !important;
  -moz-cursor: url('https://pocketsite.in/dash/assets-card/img/projects.cur'), projetos !important;
}
.blog-item-thumb img {
  width: 100%;
}
