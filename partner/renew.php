                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        if(isset($_POST['renew'])){
                            ...
                            if(empty($day) || empty($month) || empty($year)){
                                echo "<script>alert('Failed To Renew, Day or Month or Year cant be empty.'); window.location='renew'</script>";
                                die();
                            }
                            
                            // $pid = $_SESSION['partner'];
                            // $qe = "SELECT * FROM `owners` INNER JOIN `reseller` ON owners.ref = reseller.partner where owners.ref = '$pid' AND owners.id = '$cust'";
                            // $data = $con->query($qe);
                            // if($data->num_rows == 0){
                            //     echo "<script>alert('Failed To Renew, Invaild Store ID.'); window.location='renew'</script>";
                            //     die();
                            // }
                                    ...
                                    <div class="table-responsive mb-4 mt-4">
                                        <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $pid = $_SESSION['partner'];
                                                $qe = "SELECT * , owners.id as oid FROM `owners` INNER JOIN `reseller` ON owners.ref = reseller.partner where reseller.id = '$pid' ORDER BY owners.id DESC";
                                                $data = $con->query($qe);
                                                $srno = 1;
                                                if($data->num_rows > 0){
