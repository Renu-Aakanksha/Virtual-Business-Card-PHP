                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $qe = "SELECT *, notification.id as nid FROM `notification` INNER JOIN `owners` ON notification.cust = owners.id where owners.ref = '$pid' ORDER BY notification.id DESC LIMIT 10";
                                        $data = $con->query($qe);
                                        $srno = 1;
                                        if($data->num_rows > 0){
                                            while($rows = $data->fetch_assoc()){
