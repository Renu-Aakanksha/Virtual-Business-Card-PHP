...
<body>
	                ...
	                <div class="widget-content widget-content-area text-center">
	                	<nav class="breadcrumb-two" aria-label="breadcrumb">
						    <ol class="breadcrumb">
						        ...
						        <li class="breadcrumb-item active"><a href="javascript:void(0);">&nbsp; Customer Notification</a></li>
						    </ol>
						</nav>
					</div>
	...
	<p align="justify"><strong>Instruction :</strong> Write and upload a short "Notification" for your valuable customers that will be displayed at your storefront 
	for your customer reference.</p>
	<hr style="border: 1px solid;">
                        ...
                        if(isset($_POST['catsub'])){
                            ...
                            if(empty($titler)){
                                echo "<script>alert('Faild To Sent Notification, Notification Title cant be empty.'); window.location='notification'</script>";
                                die();
                            }
                            
    						$qqe = "INSERT INTO `notification`(`title`, `message`, `cust`, `datee`) VALUES ('$titler','$messager','$user','$datee')";
                        ...
                        if(isset($_GET['delid'])){
                            $del = $_GET['delid'];
                            $qqede = "DELETE FROM `notification` WHERE `id`='$del'";
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
			    						$user = $_SESSION['user'];
			    						$qef = "SELECT * FROM `notification` WHERE `cust`='$user'";
			    						$dataf = $con->query($qef);
			    						if($dataf->num_rows > 0){
