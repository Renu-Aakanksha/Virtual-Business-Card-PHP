				...
				<div class="col-sm-12">
					<div class="Register-form-panel">
						<div class="row">
							...
							<p class=" text-center"><strong>Login User Id & Password has been sent to your registered email id.</strong></p>
							<!--<p class=" text-center" style="color: #fe5417;">Please complete the payment process to activate your account</p>-->
					     	<p class=" text-center"><a href="index" class="btn btn-new btn-lg">Click Here to Login</a></p>
